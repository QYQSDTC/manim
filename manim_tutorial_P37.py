...
class MoreShapes(Scene):
    ...
    def construct(self):
        ...
        self.play(Rotating(square),FadeIn(circle), time=3)
...
class MovingShapes(Scene):
    ...
    def construct(self):
        ...
        Text1=TextMobject("Circle 1")
        Text1.move_to(LEFT)
        Text1.set_color(RED_A)
        circle.surround(Text1)
        square=Circle()
        Text2=TextMobject("Circle 2")
        Text2.set_color(ORANGE)
        Text2.move_to(LEFT+3*DOWN)
        square.surround(Text2)
        

        self.play(Write(Text1), Write(Text2), time= 2)
        self.play(GrowFromCenter(circle), GrowFromCenter(square), rate=5)
        self.play(ApplyMethod(Text1.move_to,RIGHT), ApplyMethod(Text2.shift,RIGHT))
...
class AddingMoreText(Scene):
    ...
    def construct(self):
        ...
        author.scale(0.75)
        author.next_to(quote.get_corner(DOWN+LEFT),DOWN)
        ...
        self.play(FadeOut(quote)) # quote2 -> quote
...
class UsingBraces(Scene):
    ...
    def construct(self):
        ...
        self.play(ShowCreation(eq1A, eq1B, eq1C))
        self.play(ShowCreation(eqeq2A, eq2B, eq2C))
